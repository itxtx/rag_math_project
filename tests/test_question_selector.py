...
class TestQuestionSelector(unittest.TestCase):
    ...
    async def test_select_next_question_flow_chooses_review(self):
        ...
        mock_review_concept_info = {
            "concept_id": "concept_review", "concept_name": "Review Me", 
            "current_score": 3.0, "is_review": True, "doc_id": "doc1"
        }
        ...
        self.assertEqual(result["question_text"], "Review question?")
    ...
    async def test_select_next_question_flow_chooses_new(self):
        ...
        mock_new_concept_info = {
            "concept_id": "concept_new", "concept_name": "New Concept", 
            "is_review": False, "doc_id": "doc_new"
        }
        self.selector._select_new_concept = AsyncMock(return_value=mock_new_concept_info)
        
        self.mock_retriever.get_chunks_for_parent_block.return_value = [
            {"chunk_text": "Context for new concept.", "chunk_id": "chunk_new1"}
        ]
